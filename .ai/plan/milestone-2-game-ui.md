...
- [x] Прогнать полную партию от spymaster RED: подсказка → operative RED угадывает верно × count → ход переходит автоматически
- [x] Проверить: нейтральная карта → ход переходит мгновенно
- [x] Проверить: тап убийцы → мгновенный проигрыш
- [x] Проверить: operative видит закрытые как одинаковые; spymaster видит все цвета
